...
func TestGetChecklist(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			GetChecklist(tt.args.c)
		})
	}
}

func TestPutChecklist(t *testing.T) {
	type args struct {
		c *gin.Context
	}
	tests := []struct {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			PutChecklist(tt.args.c)
		})
	}
}

func TestPostChecklist(t *testing.T) {
	type args struct {
		c *gin.Context
	}
	tests := []struct {
...
func TestPutAllItems(t *testing.T) {
	type args struct {
		c *gin.Context
	}
	tests := []struct {
